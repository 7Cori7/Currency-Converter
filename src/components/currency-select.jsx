...
export default function CurrencySelect({selectedCurrency, handleCurrency}){

    // Get the country code to display it's flag
    ...
    return <div className="currency-select">
        ...
        <select className="currency-dropdown" onChange={handleCurrency}>
            ...
            {/* Default option */}
            <option defaultValue={selectedCurrency}>{selectedCurrency}</option>
